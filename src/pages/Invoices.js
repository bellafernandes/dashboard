            ...
            <div className="flex flex-col">
              <div className="w-full lg:w-2/3 mx-auto flex lg:items-center lg:justify-between">
                <div className="min-w-0 flex-1">
                  {/* Title */}
                  <div className="w-36 h-8 rounded-lg container" />
                  <div className="w-40 h-6 mt-2 rounded-lg container" />
                </div>
                <div className="mt-5 flex justify-end lg:mt-0 lg:ml-4">
                  <div className="w-32 h-10 mr-6 rounded-lg container" />

                  <div className="w-32 h-10 rounded-lg container" />
                </div>
              </div>
            </div>

            <table className="w-full lg:w-2/3 mx-auto mt-4">
              <tbody className="mx-auto">
                {invoiceData.map((el) => (
                  <>
                    <div class="flex justify-between bg-gray-100 items-center px-10 py-4 text-gray-300 rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 dark:bg-zinc-900 dark:border-gray-700 mt-4">
                      ...
                      <div className="w-28 h-6 rounded-lg container" />
                      <td className="py-4 px-6 ml-14 flex w-1/4 justify-center">
                        <div className="w-40 h-6 rounded-lg container" />
                      </td>
                      <td className="py-4 px-6 flex w-1/4 justify-center">
                        <div className="w-28 h-6 rounded-lg container" />
                      </td>
